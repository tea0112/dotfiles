...
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-5 "['<Super>d']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-6 "['<Super>f']"
...
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-10 "['<Super>v']"
