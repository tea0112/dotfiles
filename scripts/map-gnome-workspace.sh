...
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-7 "['<Super>g']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-8 "['<Super>4']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-9 "['<Super>r']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-10 "['<Super>f']"
