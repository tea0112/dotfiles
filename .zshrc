...
alias pn='cd ~/notes && git add . && if [ $(git commit -m "update" && git push -u origin master) -eq 0 ]; then cd -; fi && cd -'
...
alias rcf="bash ~/dotfiles/installation-scripts/config-arch.sh"
